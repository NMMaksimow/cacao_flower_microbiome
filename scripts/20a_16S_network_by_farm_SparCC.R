...
##   - permTest = TRUE with N_PERM permutations (slow; dominates HPC runtime)
...
##   results/tables/20a_network_comparison.csv
##
## Compute only — no figures. Render panels locally with 20a_16S_network_SparCC_vis.R
## ============================================================================
...
for (farm in FARM_LEVELS) {
        ...
        # permTest = TRUE: SparCC permutations are very slow and dominate runtime.
        net_raw <- tryCatch(
                netConstruct(
                        data        = ps_bag,
                        data2       = ps_unb,
