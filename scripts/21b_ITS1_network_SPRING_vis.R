## ============================================================================
## 21b — Network visualization: ITS1 OTU97 fungi (bagged vs unbagged) — SPRING
##
## Standalone visualization script: loads 21b_network_results.rds and renders
...
## Output:
##   results/figures/21b_network_panels_spring.png
## ============================================================================

# ── 0. Parameters ─────────────────────────────────────────────────────────────

PREV_THRESH_NET <- 0.20    # 20% per group; used in caption only
SPRING_LAMBDA_N <- 15L     # lambda grid size; used in caption only
SPRING_REP_NUM  <- 10L     # stability selection replicates; used in caption only
