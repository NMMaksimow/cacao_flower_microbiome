## ============================================================================
## 21a — Network visualization: 16S bacteria (bagged vs unbagged) — SPRING
##
## Standalone visualization script: loads 21a_network_results.rds and renders
...
## Output:
##   results/figures/21a_network_panels_spring.png
## ============================================================================
