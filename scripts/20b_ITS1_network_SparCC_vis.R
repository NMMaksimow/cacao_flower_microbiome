## ============================================================================
## 20b — Network visualization: ITS1 OTU97 fungi (bagged vs unbagged) — SparCC
##
## Standalone visualization script: loads 20b_network_results.rds and renders
...
## Output:
##   results/figures/20b_network_panels_sparcc.png
## ============================================================================

# ── 0. Parameters ─────────────────────────────────────────────────────────────

PREV_THRESH_NET <- 0.20    # 20% per group; used in caption only
SPARCC_THRESH   <- 0.5     # |r| edge threshold; used in caption only
...
caption_str <- sprintf(
        "SparCC  |  prevalence >= %.0f%%  |  |r| >= %.2f edge threshold  |  hub nodes = black border, italic label",
