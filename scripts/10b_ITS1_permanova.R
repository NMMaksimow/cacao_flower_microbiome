...
# Computed and saved by 08b_ITS1_pcoa_global.R.
# Re-run 08b if these files are missing or outdated.
...
ggsave(here("results", "figures", "10b_ITS1_perm_farm_heatmap.png"),
...
ggsave(here("results", "figures", "10b_ITS1_perm_combined_r2.png"),
       plot = p_comb, width = 12, height = 5, dpi = 300)

# ---- 7. Save outputs -----------------------------------------------------
write_csv(results_perm_farm,
          here("results", "tables", "10b_ITS1_permanova_per_farm.csv"))
write_csv(results_combined,
          here("results", "tables", "10b_ITS1_permanova_combined.csv"))
write_csv(results_permdisp,
          here("results", "tables", "10b_ITS1_permdisp.csv"))
write_csv(results_permdisp_farm,
          here("results", "tables", "10b_ITS1_permdisp_per_farm.csv"))
