...
#SBATCH --output=logs/zeta/zeta_ITS1_%a.out
#SBATCH --error=logs/zeta/zeta_ITS1_%a.err

# Zeta-diversity decline – ITS1 fungi
...
# Usage:
#   mkdir -p logs/zeta
#   sbatch scripts/zeta_ITS1_array.sh

echo "=== Zeta ITS1 | order ${SLURM_ARRAY_TASK_ID} ==="
echo "Date:  $(date)"
echo "Host:  $(hostname)"
