## ============================================================================
## 20a — Network visualization: 16S bacteria (bagged vs unbagged) — SparCC
##
## Standalone visualization script: loads 20a_network_results.rds and renders
...
## Output:
##   results/figures/20a_network_panels_sparcc.png
## ============================================================================
