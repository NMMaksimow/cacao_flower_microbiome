...
# ps_ITS1_bacteria_biosamples <- readRDS(here("results", "rds", "ps_ITS1_fungi_biosamples.rds"))
# decontam_ITS1_results  <- readRDS(here("results", "rds", "decontam_prev05_ITS1.rds"))
...
plot_read_retention_stacked_ITS1 <-
        function(grouping_variable,
                ...
                p <- read_retention_loss_table_ITS1 |>
                        (\(x) {
...
p_ret_sublibrary <- plot_read_retention_stacked_ITS1(grouping_variable = "sublibrary_id")
ggsave(here("results", "figures", "04b_ITS1_read_retention_by_sublibrary.png"),
       plot = p_ret_sublibrary, width = 10, height = 5, dpi = 300)

# Plot decontamination and off-target filtering results by sample type
p_ret_sample_type <- plot_read_retention_stacked_ITS1(
...
ggsave(here("results", "figures", "04b_ITS1_read_retention_by_sample_type.png"),
...
p_ret_farm_mgmt <- plot_read_retention_stacked_ITS1(
...
ggsave(here("results", "figures", "04b_ITS1_read_retention_by_farm_management.png"),
...
p_ret_pollination <- plot_read_retention_stacked_ITS1(
...
ggsave(here("results", "figures", "04b_ITS1_read_retention_by_pollination.png"),
...
p_ret_germination <- plot_read_retention_stacked_ITS1(
...
ggsave(here("results", "figures", "04b_ITS1_read_retention_by_germination.png"),
       plot = p_ret_germination, width = 6, height = 5, dpi = 300)

# Does sequencing depth confound pollination intensity? No
p_scatter_pi <- read_retention_loss_table_ITS1 |>
        dplyr::filter(
                !is.na(pi_clsm),
                pi_clsm > 0,
        ...
        theme_bw()
ggsave(here("results", "figures", "04b_ITS1_depth_vs_pi_clsm.png"),
       plot = p_scatter_pi, width = 6, height = 5, dpi = 300)

# Does sequencing depth confound callose_plug_index? No
p_scatter_callose <- read_retention_loss_table_ITS1 |>
        dplyr::filter(
        ...
        theme_bw()
ggsave(here("results", "figures", "04b_ITS1_depth_vs_callose_plug_index.png"),
...
p_box_sample_type <- dplyr::bind_rows(
        ...
        geom_boxplot() +
        theme_bw()
ggsave(here("results", "figures", "04b_ITS1_depth_boxplot_by_sample_type.png"),
...
ggsave(here("results", "figures", "04b_ITS1_depth_boxplot_by_sublibrary.png"),
...
p_box_treatment <- dplyr::bind_rows(
        ...
        geom_boxplot() +
        theme_bw()
ggsave(here("results", "figures", "04b_ITS1_depth_boxplot_by_flower_treatment.png"),
...
ggsave(here("results", "figures", "04b_ITS1_depth_boxplot_by_farm.png"),
...
p_depth_farm_type <- dplyr::bind_rows(
        ...
        labs(x = "Farm ID and management type", y = "Reads (fungi only)",
             fill = "Sample type") +
        theme_bw() +
        theme(
                strip.placement  = "outside",
...
ggsave(here("results", "figures", "04b_ITS1_depth_boxplot_by_farm_and_sample_type.png"),
...
p_box_pollination <- dplyr::bind_rows(
        ...
        geom_boxplot() +
        theme_bw()
ggsave(here("results", "figures", "04b_ITS1_depth_boxplot_by_pollination.png"),
...
p_box_germination <- dplyr::bind_rows(
        ...
        geom_boxplot() +
        theme_bw()
ggsave(here("results", "figures", "04b_ITS1_depth_boxplot_by_germination.png"),
...
p_scatter_dna <- dplyr::bind_rows(
        ...
        ggplot(aes(x = dna_concentration_hs_its1, y = n_reads, color = sample_type)) +
        geom_point() +
        theme_bw()
ggsave(here("results", "figures", "04b_ITS1_depth_vs_dna_concentration.png"),
