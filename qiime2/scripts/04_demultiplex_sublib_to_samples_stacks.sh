...
#SBATCH --output=logs/04_demultiplex_stacks.out
#SBATCH --error=logs/04_demultiplex_stacks.err
...
OUTPUT_16S="qiime2/import/demux/demultiplexed_sample_files/16S"
OUTPUT_ITS1="qiime2/import/demux/demultiplexed_sample_files/ITS1"
